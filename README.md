...
2. Clone the repo.
   ```sh
   git clone https://github.com/Veereshdoddamani/Blockchain-based-organ-donation-platform.git
   ```
...
* [Shashank M](https://github.com/m-shashank18)
* [Tarun S V Naik](https://github.com/Tarun-s-v-naik)
* [V Sai Abhijith](https://github.com/VSaiAbhijith)
* [Veeresh Doddamani](https://github.com/Veereshdoddamani)
